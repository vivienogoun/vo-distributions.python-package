...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.p = len(list(filter(lambda x: x == 1, self.data))) / len(self.data)
        self.calculate_mean()
    ...
    def pdf(self, k):
        ...
        factnk = math.factorial(nminusk)

        return (factn / (factk * factnk)) * ((p ** k) * ((1 - p) ** (nminusk)))
